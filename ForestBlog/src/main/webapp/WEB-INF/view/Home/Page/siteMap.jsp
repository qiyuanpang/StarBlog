    ...
    <section id="primary" class="content-area" style="background: #fff;">
        <main id="main" class="site-main" role="main">
            <div class="layui-collapse">
                        ...
                        <ul>
                            <c:forEach items="${articleList}" var="a">
                                <li style="padding: 5px">
                                    <a href="/article/${a.articleId}" title="ajax form" target="_blank">${a.articleTitle}</a>
                                </li>
                            </c:forEach>
                ...
                <div class="layui-colla-item">
                    <h2 class="layui-colla-title">Cotegories</h2>
                    <div class="layui-colla-content layui-show">
                        <ul>
                ...
                <div class="layui-colla-item">
                    <h2 class="layui-colla-title">Tags</h2>
                    <div class="layui-colla-content layui-show">
                        <c:forEach items="${tagList}" var="t">
                            <a href="/tag/${t.tagId}" style="font-size: ${t.articleCount/4+14}px" title="${t.articleCount} topics" target="_blank">${t.tagName}</a>
                        </c:forEach>
                    </div>
                </div>
            </div>
