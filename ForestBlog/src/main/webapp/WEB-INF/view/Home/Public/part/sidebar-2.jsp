...
<div id="sidebar" class="widget-area all-sidebar"
    ...
    <aside class="widget about">
        <h3 class="widget-title">
            <i class="fa fa-bars"></i>About this site
        </h3>
        <div id="feed_widget">
            <div class="feed-about">
                ...
                <div class="about-inf">
                    ...
                    <span class="about-cn">Massage ${siteBasicStatistics[1]} </span>
                </div>
            </div>
        </div>
        <div class="clear"></div>
    ...
    <aside id="php_text-22" class="widget php_text">
        <h3 class="widget-title">
            <i class="fa fa-bars"></i>Website Outline
        </h3>
