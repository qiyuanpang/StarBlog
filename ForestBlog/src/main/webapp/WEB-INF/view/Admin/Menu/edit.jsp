    ...
    <div class="layui-row">
        <div class="layui-col-md4" >
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        <select name="menuLevel" id="">
                            <option value="1" <c:if test="${menu.menuLevel==1}">selected</c:if>>Top Menu</option>
                            <option value="2" <c:if test="${menu.menuLevel==2}">selected</c:if> >Main Menu</option>
                        </select>
                    </div>
                    <br>
                    <div class="layui-input-block">
            ...
            <blockquote class="layui-elem-quote layui-quote-nm">
                Notice:
                <ul>
                    <li>1. The range of Order is from 0 to 10. 1 by default.</li>
                    <li>2. Icon (optional) will be shown to the left of Name. e.g., <a href="http://fontawesome.io/icons/" target="_blank">fontawesome</a>Icon</li>
                    <li>3. Only two menus are available so far: Top Menu and Main Menu.</li>
                </ul>
            </blockquote>
        </div>
