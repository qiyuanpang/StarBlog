...
<html xmlns="http://www.w3.org/1999/xhtml" lang="zh-CN">
    ...
    <html xmlns="http://www.w3.org/1999/xhtml" lang="zh-CN">
        <head>
            ...
            <title>${options.optionSiteTitle} &lsaquo; Sign Up</title>
        ...
        <body class="login login-action-login wp-core-ui  locale-zh-cn">
            <div id="login">
                <h1><a href="/" title="Welcome to my blog!" tabindex="-1">${options.optionSiteTitle}</a></h1>
                ...
                <p id="backtoblog"><a href="/">&larr; Return to blog</a> | <a href="/login">Sign Up</a></p>
            ...
            <script type="text/javascript">
                ...
                $("#submit-btn").click(function () {
                    ...
                    if (user == "" || nickname == "" || email == "" || password == "" || confirmPass == "") {
                        ...
                        alert("Make sure your password are the same!");
                    } else if(user.length < 4 || user.length > 20) {
                        alert('Username should contain 5 to 19 characters!');
                    } else {
                        $.ajax({
