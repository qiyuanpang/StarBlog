...
function increaseViewCount(articleId) {
    if ($.cookie("viewId") != articleId || $.cookie("viewId") == null) {
        $.ajax({
            ...
            error: function () {
                alert("An error occur when accessing data!");
            },
        });
    }
}
...
$("#applyLinkForm").submit(function () {
    $.ajax({
        ...
        success: function () {
            alert("Applied successfully. Your application is now under review!");
        }
    })
})
