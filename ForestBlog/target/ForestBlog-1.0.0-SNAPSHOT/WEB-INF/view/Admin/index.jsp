            ...
            <div id="dashboard_activity" class="postbox ">
                <div class="inside">
                    <div id="activity-widget">
                        <div id="published-posts" class="activity-block"><h3>Recent Articles</h3> <br>
                            <ul>
                        ...
                        <br>
                        <div id="latest-comments" class="activity-block"><h3>Recent Comments</h3>
                                    ...
                                    <li class="comment   thread-even comment-item approved">
                                        ...
                                        <div class="dashboard-comment-wrap has-row-actions">
                                            <p class="comment-meta">
                                                Created by <cite class="comment-author">
                                            ...
                                            <a data-comment-id="1268"
                                               href="/admin/comment/reply/${c.commentId}">
                                                ...
                                                <span class=""> |
                                                <a href="/admin/comment/edit/${c.commentId}">Edit</a>
                                            </span>
                                                <span class=""> |
            ...
            <div id="dashboard_quick_press" class="postbox ">
                <div class="inside">
                    <form name="post" method="post" id="insertDraftForm"
                        ...
                        <div class="layui-form-item">
                            <div class="layui-input-block">
                                <input type="text" name="articleTitle" id="articleTitle" required  lay-verify="required" placeholder="title" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item layui-form-text">
                            <div class="layui-input-block">
                                <textarea name="articleContent" placeholder="content" id="articleContent" class="layui-textarea" required></textarea>
                            </div>
                        </div>
                        <input type="hidden" name="articleStatus" value="0">
                        <div class="layui-form-item">
                            <div class="layui-input-block">
                                <button class="layui-btn layui-btn-small" lay-submit lay-filter="formDemo" onclick="insertDraft()">Save draft</button>
                                <button type="reset" class="layui-btn layui-btn-small layui-btn-primary">Reset</button>
                            </div>
                        </div>
                    ...
                    <div class="drafts"><p class="view-all"><a
                            href="/admin/article"
                            aria-label="viewalldrafts">View all</a></p>
                        <h2 class="hide-if-no-js">Draft</h2>
                        <ul>
                                ...
                                <c:if test="${a.articleStatus==0}">
                                    <li>
                                        <div class="draft-title"><a
                                            ...
                                            <time ><fmt:formatDate value="${a.articleCreateTime}" pattern="yyyy-MM-dd"/></time>
                                        </div>
                                    </li>
                                </c:if>
                            </c:forEach>
