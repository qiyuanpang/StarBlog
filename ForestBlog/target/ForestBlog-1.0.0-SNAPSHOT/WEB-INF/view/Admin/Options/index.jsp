                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <div class="layui-upload">
                            ...
                            <button type="button" class="layui-btn" id="test1">Upload a photo</button>
                            <input type="hidden" id="optionAboutsiteAvatar" name="optionAboutsiteAvatar" value="${option.optionAboutsiteAvatar}">
                        </div>
                    </div>
                    <div class="layui-form-mid layui-word-aux">recommend 150px*150px</div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <div class="layui-upload">
                            ...
                            <button type="button" class="layui-btn" id="test2">Upload Photo</button>
                            <input type="hidden" id="optionAboutsiteWechat" name="optionAboutsiteWechat" value="${option.optionAboutsiteWechat}">
                        </div>
                    </div>
                    <div class="layui-form-mid layui-word-aux">recommend 430px*430px</div>
        ...
        layui.use('upload', function () {
            ...
            var uploadInst = upload.render({
                ...
                error: function () {
                    ...
                    demoText.html('' +
                        '<span style="color: #FF5722;">Falied to upload!</span>' +
