...
<rapid:override name="content">
    ...
    <blockquote class="layui-elem-quote">
         <span class="layui-breadcrumb" lay-separator="/">
              <a href="/admin">Home</a>
              <a href="/admin/profile">Personal Info</a>
              <a><cite>Edit profile</cite></a>
        </span>
    </blockquote>
    <br><br>
    <form class="layui-form" action="/admin/profile/save" id="userForm"
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">Username <span style="color: #FF5722; ">*</span></label>
            <div class="layui-input-inline">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">Nickname <span style="color: #FF5722; ">*</span></label>
            <div class="layui-input-inline">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="radio" name="userStatus" value="1" title="normal" <c:if test="${user.userStatus==1}">checked</c:if>>
                <input type="radio" name="userStatus" value="0" title="baned" <c:if test="${user.userStatus==0}">checked</c:if>>
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-input-block">
