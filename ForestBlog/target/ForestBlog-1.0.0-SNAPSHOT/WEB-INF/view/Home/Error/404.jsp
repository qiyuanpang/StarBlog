...
<div class="error-page">
    <div class="error-page-container">
        <div class="error-page-main">
            <h3>
                <strong>404</strong>Sorry, the page does not exist!
            </h3>
            <div class="error-page-actions">
                <div>
                    <h4>Possible reasons:</h4>
                    <ol>
                        <li>Your internet connection is poor or unstable;</li>
                        <li>We cannot find the page you requested;</li>
                        <li>Wrong url entered</li>
                    </ol>
                </div>
                <div>
                    <h4>You could try:</h4>
                    <ol>
                        ...
                        <li><a href="https://liuyanzhao.com/message.html">Report this on massage board</a></li>
                        <li>
                            <a target="_blank" rel="external nofollow" href="http://wpa.qq.com/msgrd?v=3&amp;uin=847064370&amp;site=qq&amp;menu=yes"><i class="fa fa-qq"></i>Contact us</a>
                        </li>
                    </ol>
                </div>
            </div>
