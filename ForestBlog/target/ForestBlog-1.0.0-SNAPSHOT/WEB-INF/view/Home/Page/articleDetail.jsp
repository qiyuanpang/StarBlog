    ...
    <div id="primary" class="content-area">
        <main id="main" class="site-main" role="main">
                ...
                <div class="entry-content">
                    ...
                    <div class="s-weixin">
                        <ul class="weimg1">
                            ...
                            <li>Chat with me ASAP</li>
                            <li><img src="/img/weixin.jpg"></li>
                        </ul>
                        <ul class="weimg2">
                            <li><strong>My blog community</strong></li>
                    ...
                    <div id="social">
                        <div class="social-main">
                            <span class="like">
                                <a href="javascript:;" data-action="ding" data-id="1" title="Thumbs Up"
                            ...
                            <div class="shang-p">
                                ...
                                <span class="shang-s">
                                    <a onclick="PaymentUtils.show();" style="cursor:pointer">Fund</a>
                                </span>
                            </div>
                            <div class="share-sd">
                    ...
                    <footer class="single-footer">
                        ...
                        <div class="single-cat-tag">
                            <div class="single-cat">Categories:
                                <c:forEach items="${article.categoryList}" var="c">
                                    <a href="/category/${c.categoryId}">
                                            ${c.categoryName}
                                    </a>
            ...
            <div class="authorbio wow fadeInUp">
                ...
                <ul class="postinfo">
                    <li></li>
                    <li><strong>Copyright:</strong>created by
                        <strong>
                    ...
                    <li class="reprinted"><strong>Indicate the source if reproduce: </strong>
                        <a href="/article/${article.articleId}"
                           rel="bookmark"
                           title="fixed link /article/${article.articleId}">
            ...
            <div id="single-widget">
                <div class="wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <aside id="hot_post-8" class="widget hot_post">
                        <h3 class="widget-title"><span class="s-icon"></span>You may like</h3>
                ...
                <div id="respond" class="comment-respond">
                    <h3 id="reply-title" class="comment-reply-title"><span id="reply-title-word">Comment</span>
                        ...
                        <c:if test="${sessionScope.user == null}">
                            <span style="color:red" >Please sign in first to comment<a href="/login" target="_blank">Sign in</a></span>
                        </c:if>
                    </h3>
                    ...
                    <form id="comment_form" method="post">
                        <c:if test="${sessionScope.user!=null}">
                            <div class="user_avatar">
                                ...
                                <br> <a href="javascript:void(0)" onclick="logout()">Sign Out</a>
                            </div>
                        </c:if>
                                ...
                                <div id="div-comment-${c.commentId}" class="comment-body">
                                    <div class="comment-author vcard">
                                        ...
                                        <c:if test="${c.commentRole == 1}">
                                            ...
                                            <span class=""
                                                  style="margin-top: 2px!important;color: #c40000;font-size: 13px;;"><b>Author</b></span>
                                        </c:if>
                                        <span class="comment-meta commentmetadata">
                                            <span class="ua-info" style="display: inline;">
                                                ...
                                                <span class="comment-aux">
                                                    ...
                                                    <span class="floor"> &nbsp;${floor} comment </span>
                                                </span>
                                            </span>
                                        </span>
                                        <p>
                                            ...
                                            <li class="comment">
                                                <div id="div-comment-${c.commentId}" class="comment-body">
                                                    ...
                                                    <span class="comment-aux">
                                                        ...
                                                        <span class="floor"> &nbsp;${floor2} comment </span>
                                                    </span>
                                                </span>
                                                    </span>
                                                        <p>
